...
\begin{abstract}
  ...
  It will have a variety of enemies and weapons. There will be magic. The different types of magic for the player to use would include pyromancy, sorcery, and faith based magic.  You can upgrade weapons and get access to abilities in the game.
