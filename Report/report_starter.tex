...
\begin{abstract}
  UPDATED---\today. The project that our group is doing is a 3D real time game in the Unreal engine. 
  ...
  The boss will typically have a mechanic that makes him different compared to the other enemies in the level. \end{abstract}
