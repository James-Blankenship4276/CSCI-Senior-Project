...
\begin{abstract}
  UPDATED---\today.   UPDATED---\today. The project that our group is doing is a 3D real time game in the Unreal engine. 
  The game is set in medieval time with magic. The game will have multiple levels in it.
  It will have a variety of enemies and weapons. You can upgrade weapons and get access to abilities in the game.
