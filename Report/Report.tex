...
To indroduce this project we decided to develop a game. The game will have the title of  "The Deep Jorney". This gameplay has a viewpiont of first-person. The genral setting is that of medival fantasy. The game will be made up of three diffrent levels. The first level will be where the character will start out in and it will be the castle level that includes a courtyard and the interior of the castle itself. The second level will be the castles dungeon which will include harder enemies which will drop diffrent weapons or loot. The third level will be the woods area adjacent to the castle. The character player will have diffrent type of weapons to choose from which will include swords or staffs . The weapons the character player can use will have diffrent upgrades available that can increase damage. The character player will be facing off against diffrent ai enemies types including orcs, goblins, and humans.  The character will also be able to wield diffrent kinds of magic. There will be three diffrent types of magic the character can wield pyromancy,faith magic, and sorcery.  \LaTeX.
