...
\section{Introduction}
  ...
  \item There are 3 different levels.
    \bigskip
  \item The three levels are  the castle level,castle basement, and the fort area.
    \bigskip
 ...
 \frameT{Classes} {
    \begin{enumerate}
  \item Warrior:Melee focused with abilities to make him a tank.
  \bigskip
...
\frameT{Project Development} {
   \begin{enumerate}
    \item We figured out how to add more levels and added a basement and a fort area. 
    \bigskip
...
\begin{enumerate}
  \item Blueprint system gets cluttered when doing more complex tasks. 

  \bigskip

  \item Animations would leave the characters static mesh sometimes. 
  
  \bigskip

 \item Getting the projectiles to work.
 
 \bigskip
 
 \item Getting the AI to work. 
 \includegraphics[width=6cm, height=4cm, center]{figures/messy.jpg}
 \end{enumerate}
}
\frameT{Future Work} {
\begin{enumerate}
