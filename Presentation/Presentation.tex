...
\frameT{Motivation} {
  ...
  \bigskip
  \begin{enumerate}
    \item The group likes to play video games so that was the reason to make a game for the project 
    \bigskip
    \item The group likes medival settings so that was why we choose that as our settings
  \end{enumerate}
}
  ...
  \begin{enumerate}
    ...
    \item Character will have access to abilities 
  \end{enumerate}
  }
